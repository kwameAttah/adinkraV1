...
const consumerKey ="ck_cd1a5cec7ff41891ca4cc67667dc35590e54826d";  //'ck_4c5dea07e73878ceb71699f6e44a46daee5b19ba';
const consumerSecret ="cs_b9853dedb6170e9a2daf9bab2587581a1d1e9680" //'cs_f3febffaafcddd76597641d740957f4b0b7673ee';
...
export default {
   ...
   */
  WooCommerce: {
    url: 'http://demos.pijeyltd.com/',//'https://demo.mstore.io/'
    consumerKey,
    consumerSecret,
  },
  ...
  WebPages: { marketing: 'http://demos.pijeyltd.com/' },

  intro: [
    {
      key: 'page1',
      title: 'Welcome to Adinkra Wallet !',
      text: 'Effortless Shopping, Seamless Paying: Experience Simplicity in Every Transaction',
      icon: 'ios-basket',
      colors: ['#e1a02c', '#1f1518'],
    },
    {
      key: 'page2',
  ...
  ProfileSettings: [
    ...
    },
    {
      ...
      routeName: 'CustomPage',
      params: {
        url: 'http://demos.pijeyltd.com/privacy',
      },
    },
    {
      label: 'termCondition',
      routeName: 'CustomPage',
      params: {
        url: 'http://demos.pijeyltd.com/term-of-service',
      },
    },
    {
      label: 'About',
